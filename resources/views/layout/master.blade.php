...
<head>
	...
	<!-- Global stylesheets -->
	@yield('link')<link href="https://fonts.googleapis.com/css?family=Roboto:400,300,100,500,700,900" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="{{asset('LTR/assets/js/pages/navbar_components.js')}}"></script>

	<!-- /theme JS files -->
	<script type="text/javascript" src="{{ asset('LTR/assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{ asset('LTR/assets/js/pages/user_pages_profile.js')}}"></script>
...
<body>
	...
	<div class="navbar navbar-inverse bg-teal navbar-component" style="position: relative; z-index: 29;">
		<div class="navbar-header">
					...
					<a class="navbar-brand" href="{{ url('/beranda') }}"><img src="{{asset('LTR/assets/images/logo_light.png')}}" alt=""></a>
									...
									<ul class="nav navbar-nav navbar-right">
										<li class="dropdown dropdown-user">
											...
											<ul class="dropdown-menu dropdown-menu-right">
												...
												<li><a href="{{url('/list')}}"><i class="icon-user-plus"></i> List user</a></li>
